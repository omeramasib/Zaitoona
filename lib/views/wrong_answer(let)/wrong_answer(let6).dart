...
import 'package:zaytoona/views/question_let/question_let7.dart';
import 'package:zaytoona/views/questions_grammer/question_grammer2.dart';

class WrongAnswerL6 extends StatefulWidget {
  @override
  _WrongAnswerState createState() => _WrongAnswerState();
}

class _WrongAnswerState extends State<WrongAnswerL6> {
  @override
                ...
                children: [
                   GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Questionlet7()),
                      );
                    },
                    child: Padding(
