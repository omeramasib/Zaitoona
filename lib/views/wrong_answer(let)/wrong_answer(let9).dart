...
import 'package:zaytoona/views/question_let/question_let10.dart';
...
class WrongAnswerL9 extends StatefulWidget {
  @override
  _WrongAnswerState createState() => _WrongAnswerState();
}

class _WrongAnswerState extends State<WrongAnswerL9> {
  @override
                ...
                children: [
                   GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Questionlet10()),
                      );
                    },
                    child: Padding(
