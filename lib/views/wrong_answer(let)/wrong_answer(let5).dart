...
import 'package:zaytoona/views/question_let/question_let6.dart';
import 'package:zaytoona/views/questions_grammer/question_grammer2.dart';

class WrongAnswerL5 extends StatefulWidget {
  @override
  _WrongAnswerState createState() => _WrongAnswerState();
}

class _WrongAnswerState extends State<WrongAnswerL5> {
  @override
                ...
                children: [
                   GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Questionlet6()),
                      );
                    },
                    child: Padding(
