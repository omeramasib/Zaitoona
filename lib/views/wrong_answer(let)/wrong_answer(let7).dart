...
import 'package:zaytoona/views/question_let/question_let8.dart';
import 'package:zaytoona/views/questions_grammer/question_grammer2.dart';

class WrongAnswerL7 extends StatefulWidget {
  @override
  _WrongAnswerState createState() => _WrongAnswerState();
}

class _WrongAnswerState extends State<WrongAnswerL7> {
  @override
                ...
                children: [
                   GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Questionlet8()),
                      );
                    },
                    child: Padding(
