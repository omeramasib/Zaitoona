...
class Questionlet5 extends StatefulWidget {
  @override
  _QuestionScreenState createState() => _QuestionScreenState();
}

class _QuestionScreenState extends State<Questionlet5> {
  @override
                ...
                Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        '5.What is Mrs. Fairfax? She is _',
                        style: TextStyle(
                          fontSize: 24,
                          fontWeight: FontWeight.w600,
                        ),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(right: 138, top: 20),
                                child: Text(
                                  'governess',
                                  style: TextStyle(
                                      fontSize: 23,
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.only(right: 106, top: 20),
                                child: Text(
                                  'housekeeper',
                                  style: TextStyle(
                                      fontSize: 24,
