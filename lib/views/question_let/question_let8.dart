...
import 'package:zaytoona/views/right_answer(let)/right_answer(let8).dart';
...
import 'package:zaytoona/views/wrong_answer(let)/wrong_answer(let8).dart';
import 'package:zaytoona/data/data.dart';

class Questionlet8 extends StatefulWidget {
  @override
  _QuestionScreenState createState() => _QuestionScreenState();
}

class _QuestionScreenState extends State<Questionlet8> {
  @override
